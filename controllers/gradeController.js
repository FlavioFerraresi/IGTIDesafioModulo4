...
const findOne = async (req, res) => {
  ...
  try {
    ...
    if (!data) {
      res.status(404).send('Nao encontrado a grade id: ' + id);
    } else {
      res.send(data);
    }
...
const update = async (req, res) => {
  ...
  try {
    ...
    if (!data) {
      res.send('Nao encontrado a grade id: ' + id);
    } else {
      res.send(data);
    }
...
const remove = async (req, res) => {
  ...
  try {
    ...
    if (!data) {
      res.status(404).send('Nao encontrato a grade id: ' + id);
    } else {
...
const removeAll = async (req, res) => {
  try {
    ...
    if (!data) {
      res
        .status(500)
        .send({ message: 'Erro ao excluir todos as Grades' + err });
    } else {
